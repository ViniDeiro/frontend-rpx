...
import { Eye, EyeOff, Lock, Mail, User, Calendar, Check, Phone, CreditCard, AlertTriangle } from 'react-feather';
import { useAuth } from '@/contexts/AuthContext';

// Forma simples de validação de e-mail
...
export default function RegisterPage() {
  ...
  const { register, isAuthenticated, isSimulatedMode } = useAuth();
        ...
        {isSimulatedMode && (
          <div className="bg-amber-500/10 border border-amber-500/20 text-amber-400 px-4 py-3 rounded-md flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm">O sistema está operando sem conexão com o banco de dados. Sua conta será criada localmente.</p>
            </div>
          </div>
        )}
