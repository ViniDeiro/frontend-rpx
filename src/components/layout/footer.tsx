...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: Twitter, href: 'https://twitter.com/rpxbetting', label: 'Twitter' },
    { icon: Instagram, href: 'https://instagram.com/rpxbetting', label: 'Instagram' },
    { icon: Youtube, href: 'https://youtube.com/rpxbetting', label: 'YouTube' },
    { icon: GitHub, href: 'https://github.com/rpxbetting', label: 'GitHub' },
  ];
        ...
        <div className="border-t border-border/50 pt-6 mt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-sm text-muted mb-4 md:mb-0">
              &copy; {currentYear} RPX Betting. Todos os direitos reservados.
            </div>
